...
// (DO NOT EDIT: machine generated header) 'SynHighlighterIni.pas' rev: 5.00
...
enum TtkTokenKind { tkComment, tkText, tkSection, tkKey, tkNull, tkNumber, tkSpace, tkString, tkSymbol, 
	tkUnknown };
#pragma option pop
...
public:
	...
	/* virtual class method */ virtual AnsiString __fastcall GetLanguageName() { return GetLanguageName(__classid(TSynIniSyn)
		); }
	#pragma option pop
...
__published:
	...
	__property Synedithighlighter::TSynHighlighterAttributes* SectionAttri = {read=fSectionAttri, write=
		fSectionAttri};
