...
// (DO NOT EDIT: machine generated header) 'SynHighlighterGeneral.pas' rev: 5.00
...
enum TtkTokenKind { tkComment, tkIdentifier, tkKey, tkNull, tkNumber, tkPreprocessor, tkSpace, tkString, 
	tkSymbol, tkUnknown };
#pragma option pop

#pragma option push -b-
enum TCommentStyle { csAnsiStyle, csPasStyle, csCStyle, csAsmStyle, csBasStyle, csCPPStyle };
#pragma option pop

typedef Set<TCommentStyle, csAnsiStyle, csCPPStyle>  TCommentStyles;
...
private:
	...
	AnsiString __fastcall GetIdentifierChars(void);
...
public:
	...
	/* virtual class method */ virtual AnsiString __fastcall GetLanguageName() { return GetLanguageName(__classid(TSynGeneralSyn)
		); }
	#pragma option pop
...
__published:
	__property Synedithighlighter::TSynHighlighterAttributes* CommentAttri = {read=fCommentAttri, write=
		fCommentAttri};
	__property TCommentStyles Comments = {read=fComments, write=SetComments, nodefault};
	__property bool DetectPreprocessor = {read=fDetectPreprocessor, write=SetDetectPreprocessor, nodefault
		};
	__property Synedithighlighter::TSynHighlighterAttributes* IdentifierAttri = {read=fIdentifierAttri, 
	...
	__property Synedithighlighter::TSynHighlighterAttributes* PreprocessorAttri = {read=fPreprocessorAttri
