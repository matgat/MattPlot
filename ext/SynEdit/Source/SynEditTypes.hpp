...
#define TSynWordBreakChars (System::Set<char, 0, 255> () << '\x21' << '\x22' << '\x27' << '\x28' << '\x29' \
	<< '\x2a' << '\x2b' << '\x2c' << '\x2d' << '\x2e' << '\x2f' << '\x3a' << '\x3b' << '\x3d' << '\x3f' \
	<< '\x41' << '\x42' << '\x47' << '\x48' << '\x49' << '\x4a' << '\x4b' << '\x4c' << '\x4d' << '\x4e' \
	<< '\x4f' << '\x5a' << '\x5b' << '\x5d' << '\x5f' << '\x61' << '\x62' << '\x67' << '\x68' << '\x69' \
	<< '\x6a' << '\x6b' << '\x6c' << '\x6d' << '\x6e' << '\x6f' << '\x7a' << '\x7b' << '\x7d' << '\x7f' \
	)
