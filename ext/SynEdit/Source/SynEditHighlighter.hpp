...
public:
	...
	virtual bool __fastcall LoadFromBorlandRegistry(HKEY rootKey, AnsiString attrKey, AnsiString attrName
		, bool oldStyle);
	bool __fastcall LoadFromRegistry(Registry::TRegistry* Reg);
	bool __fastcall SaveToRegistry(Registry::TRegistry* Reg);
...
protected:
	...
	virtual AnsiString __fastcall GetDefaultFilter(void);
	...
	AnsiString __fastcall GetLanguageNameProp(void);
...
public:
	...
	__property AnsiString LanguageName = {read=GetLanguageNameProp};
