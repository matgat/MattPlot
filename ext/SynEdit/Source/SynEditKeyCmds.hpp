...
public:
	...
	void __fastcall AddKey(const TSynEditorCommand ACmd, const Word AKey, const Classes::TShiftState AShift
		);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
...
static const Byte ecSelWord = 0xc6;
...
static const Byte ecCommentBlock = 0xfb;
...
static const Word ecGotFocus = 0x1e0;
static const Word ecLostFocus = 0x1e1;
...
static const Word ecUpperCaseBlock = 0x271;
static const Word ecLowerCaseBlock = 0x272;
static const Word ecToggleCaseBlock = 0x273;
